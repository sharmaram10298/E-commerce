            ...
            <div class="header-wrap">
                ...
                <div class="header-right">
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span id="cartSubTotal">$0.00</span></h4>
                                        </div>
                           ...
                           <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                <ul>
                                    <li>
                                        <a href="{{route('dashbosrd')}}"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                                    </li>
                                    <li>
                                        <a href="{{route('dashbosrd')}}"><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                                    </li>
                                    <li>
                                        <a href="{{route('dashbosrd')}}"><i class="fi fi-rs-label mr-10"></i>My Voucher</a>
                                    </li>
                                    <li>
                                        <a href="{{route('dashbosrd')}}"><i class="fi fi-rs-heart mr-10"></i>My Wishlist</a>
                                    </li>
                                    <li>
                                        <a href="{{route('dashbosrd')}}"><i class="fi fi-rs-settings-sliders mr-10"></i>Setting</a>
                                    </li>
                                    <li>
                        ...
                        @else
                        <a href="{{route('login')}}"><span class="btn btn-outline-success   btn-sm me-2">Login</span></a>
                        <a href="{{route('register')}}"><span class="btn btn-outline-success btn-sm ">Register</span></a>
