                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                    ...
                                    <img src=" " alt="product image" id="pimage" alt="image"/>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <h3 class="title-detail"><a href="" class="text-heading" id="pname"></a></h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="font-xs">
                                    <ul>
                                        ...
                                        <li class="mb-5">Stock:  <span class="badge badge-pill badge-success" id="aviable"
