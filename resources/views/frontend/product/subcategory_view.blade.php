            ...
            <div class="row align-items-center">
                <div class="col-xl-3">
                    ...
                    <div class="breadcrumb">
                        ...
                        <span></span><a href="" rel="nofollow">{{ $breadsubcat->category->category_name }}</a><span></span>{{ $breadsubcat->subcategory_name }}
                    </div>
                </div>
                ...
                <ul>
                    ...
                    <li>
                      ...
                      $products = App\Models\Product::where('category_id', $category->id)->get();
                        @endphp
                        <a href="shop-grid-right.html"> <img src="{{asset($category->category_image)}}" alt="" />{{$category->categroy_name}}</a><span class="count">{{count($products)}}</span>
                    </li>
                    @endforeach
