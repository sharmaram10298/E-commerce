...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span><a href="#">{{$product['category']['category_name']}}</a></span><span>{{$product['subcategory']['subcategory_name']}}</span><span>{{ $product->product_name}} </span> 
                        ...
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                ...
                                <figure class="border-radius-10">
                                    <img src="{{ asset($item->photo_name) }}" alt="product image" />
                                </figure>
                                @endforeach
                            ...
                            <div class="slider-nav-thumbnails">
                                ...
                                @foreach ($multiimage as $item)
                                <div><img src="{{asset($item->photo_name)}}" alt="product image" /></div>
                                @endforeach
                            </div>
                        </div>
                        <!-- End Gallery -->
                           ...
                           @else
                            <div class="attr-detail attr-size mb-30 ">
                                ...
                                <select class="form-control unicase-form-control" id="dsize">
                                    <option selected="" disable="">--Choose Size--</option>
                           ...
                           @else
                            <div class="attr-detail attr-size mb-30 ">
                                ...
                                <select class="form-control unicase-form-control" id="dcolor">
                                    <option selected="" disable="">--Choose Color--</option>
                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                ...
                                <ul class="contact-infor mb-50">
                                    @if (!empty($product['vendor'])) <!-- Check if $product['vendor'] is not null -->
                                        <li><img src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>{{ $product['vendor']['address'] }}</span></li>
                                        <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Contact Seller:</strong><span>(+91) - {{ $product['vendor']['phone'] }}</span></li>
                                    @endif
                                </ul>
                                @if (!empty($product['vendor'])) <!-- Check again before accessing vendor_short_info -->
