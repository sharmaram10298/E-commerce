@php
    $vendor_list = App\Models\User::where('status','active')->where('role','vendor')->orderBy('id','DESC')->limit(4)->get();
@endphp
                ...
                <div class="vendor-content-wrap">
                    ...
                    <div class="vendor-info mb-30">
                        <ul class="contact-infor text-muted">
                            ...
                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" /><strong>Call Us:</strong><span>(+91) - {{$vendor->phone}}</span></li>
                        </ul>
                    </div>
