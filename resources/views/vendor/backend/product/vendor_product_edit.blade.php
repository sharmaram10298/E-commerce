    ...
    <div class="card">
        ...
        {{ $products->short_descp }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="mytextarea" class="form-control" name="long_descp">
...
{{-- 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="hot_deals" type="checkbox"
                                                        value="1" id="flexCheckDefault"  {{ $products->hot_deals == 1 ? 'checked' : '' }} >
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="featured" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->featured == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="special_offer" type="checkbox"
                                                        value="1" id="flexCheckDefault" {{ $products->special_offer == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" name="special_deals" type="checkbox"
                                                        value="1" id="flexCheckDefault"  {{ $products->special_deals == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="flexCheckDefault">Special
                                                        Deals</label>
                                                </div>
                                            </div>
      ...
      <div class="page-content">
        <h6>Update Main Image Thambnail</h6>
        <hr>
        <div class="card">
            <form action="{{route('vendor.update.product.thambnail')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="file" name="product_thumbnail" id="image" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="formFile" class="form-label"></label>
                       {{-- <img src="" style="width:100px; height:100px" id="showImage" alt=""> --}}
                       <img id="showImage" src="{{asset($products->product_thumbnail)}}"  style="width:100px; height: 100px;"  >
                    </div>
                    <input type="submit" class="btn btn-primary px-4"  value="save changes">
                </div>
