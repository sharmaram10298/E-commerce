...
class IndexController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_product_2',
        'skip_category_2','skip_product_7','skip_category_7','hot_deals','special_offer','new','special_deals'));
    }
