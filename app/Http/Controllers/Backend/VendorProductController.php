...
class VendorProductController extends Controller
{
    ...
    public function VendorUpdateProdeuctThambnail(Request $request)
     {
        $pro_id = $request->id;
    ...
    public function VednorMulitImageDelelte($id){
        ...
        $notification = array(
            'message' => 'Vednor Product Multi Image Deleted Successfully',
            'alert-type' => 'success'
        );
